      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildDetailRow('Tên:', user.name, theme, Colors.white),
            _buildDetailRow('Tuổi:', '${user.age}', theme, Colors.white),
            _buildDetailRow('Cân nặng:', '${user.weight} kg', theme, Colors.white),
            _buildDetailRow('Chiều cao:', '${user.height} m', theme, Colors.white70),
            _buildDetailRow('BMI:', '${user.calculateBMI().toStringAsFixed(2)}', theme, Colors.white),
            _buildDetailRow('Phân loại BMI :', user.getBMICategory(), theme, Colors.white70),
            _buildDetailRow('Calo mục tiêu:', '${user.targetCalories} kcal', theme, Colors.white),
          ],
        ),
      ),
    );
