...
class _UserSignUpScreenState extends State<UserSignUpScreen> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      print('Đã chọn đường dẫn ảnh: ${pickedFile.path}');
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (int.tryParse(value) == null ||
                            int.parse(value) <= 0) return 'Nhập tuổi hợp lệ';
                        return null;
                      },
                    ),
                    _buildTextFormField(
                    ...
                    SizedBox(height: 20),
                    _buildSectionTitle('Chi tiết tài khoản', isDarkMode),
                    _buildTextFormField(
  ...
  Future<void> _registerUser(BuildContext context) async {
    ...
    if (email.isEmpty || password.isEmpty || name.isEmpty || age <= 0 ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Vui lòng điền tất cả các thông tin một cách chính xác.')),
      );
      setState(() {
        _isLoading = false;
      });
      ...
      if (firebaseUser == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Đăng ký không thành công: Tạo tài khoản thất bại')),
        );
        setState(() {
          _isLoading = false;
        });
      ...
      if (_profileImage != null) {
        ...
        print('Chưa chọn hình ảnh hồ sơ');
      }
