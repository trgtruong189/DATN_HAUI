...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Widget> _pages = [
    StartingScreen(
      Description: 'Chúc mừng bạn đã chạm tới bước đầu tiên để hướng tới phiên bản hoàn thiện của chính mình!',
      heading: 'Xin chào !',
      img: 'welcome',
    ),
    StartingScreen(
      Description: 'Dễ dàng ghi lại bữa ăn, đồ ăn nhẹ và lượng nước tiêu thụ.',
      heading: 'Theo dõi dễ dàng',
      img: 'EFT',
    ),
    StartingScreen(
      Description: 'Đặt ra những mục tiêu thực tế và theo dõi sự tiến bộ của bạn.',
      heading: 'Đặt mục tiêu',
      img: 'goal',
    ),
  ];
