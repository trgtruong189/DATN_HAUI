      ...
      child: ElevatedButton(
        onPressed: isLoading
          ...
          if (email.isEmpty || password.isEmpty) {
            ...
            _showSnackBar(context, 'Vui lòng điền đầy đủ thông tin.', Colors.orangeAccent);
            return;
          }
          ...
          if (loginSuccess) {
            ...
            _showSnackBar(context, 'Đăng nhập không thành công, thông tin không hợp lệ.', Colors.redAccent);
          }
        },
